...
export default function UploadArticlePage() {
  ...
  const removeAuthor = (author: string) => {
    handleChange(
      "authors",
      formData.authors.filter((a) => a !== author),
    );
  };
      ...
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div className="mb-8">
          ...
          <p className="mt-2 text-gray-600">
            Upload your own research article from plain text or PDF file.
          </p>
        </div>
                ...
                <label className="flex items-center">
                  <input
                    ...
                    onChange={(e) =>
                      handleChange(
                        "uploadType",
                        e.target.value as "text" | "pdf" | "url",
                      )
                    }
                    className="mr-2"
                  />
            ...
            {formData.uploadType === "url" && (
              <div>
                ...
                <p className="text-sm text-gray-500 mt-1">
                  Enter the URL of an article to automatically fetch and parse
                  its content
                </p>
                {errors.url && (
