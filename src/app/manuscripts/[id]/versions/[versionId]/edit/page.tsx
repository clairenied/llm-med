...
export default function EditVersionPage() {
  ...
  const fetchVersion = useCallback(async () => {
    try {
      ...
      const foundVersion = manuscript.versions.find((v: Version) => v.id === versionId);
      ...
      <div className="max-w-2xl mx-auto px-4">
        ...
        <nav className="mb-6">
          <div className="flex items-center space-x-2 text-sm text-gray-600">
            ...
            <span>/</span>
            <span className="text-gray-900">Edit Version {version?.versionNumber}</span>
          </div>
        </nav>

        {/* Page Header */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900">Edit Version {version?.versionNumber}</h1>
          <p className="mt-2 text-gray-600">Update version details and documentation.</p>
        </div>
