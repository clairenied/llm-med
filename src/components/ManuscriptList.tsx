...
export default function ManuscriptList() {
  ...
  const handleDeleteManuscript = async (manuscriptId: string) => {
    if (
      !confirm(
        "Are you sure you want to delete this manuscript? This will also delete all versions and reviews.",
      )
    ) {
      return;
    }
          ...
          <div className="flex justify-between items-center mb-4">
            ...
            <div className="flex items-center space-x-4">
              <div className="text-sm text-gray-600">
                {pagination
                  ? `${pagination.totalCount} total manuscript${pagination.totalCount !== 1 ? "s" : ""}`
        ...
        {manuscripts.length === 0 ? (
          <div className="p-8 text-center">
            ...
            <p className="text-sm text-gray-500 mt-2">
              Try running the database seed to create sample data
            </p>
          </div>
        ) : (
              ...
              >
                <div className="flex justify-between items-start mb-3">
                  ...
                  <div className="flex items-center space-x-2 ml-4">
                    <span
                      className={`px-2 py-1 text-sm font-medium rounded-full ${getStatusColor(manuscript.status)}`}
                    >
                  ...
                  <div className="flex space-x-4">
                    ...
                    {manuscript.versions.length > 0 && (
                      <span>
                        Latest version:{" "}
                        {formatDate(
                          manuscript.versions[manuscript.versions.length - 1]
                            .createdAt,
                        )}
                      </span>
                    )}
